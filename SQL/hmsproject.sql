...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 31, 2021 at 08:14 PM
...
INSERT INTO `assigned_room` (`pID`, `bID`, `rID`, `EntryDate`, `ExitDate`, `Staylength`) VALUES
(1, 19571, 7, '2021-12-23', '2021-12-30', 7),
(1, 27396, 7, '2021-12-31', '2022-01-14', 14);
...
INSERT INTO `consultation` (`pID`, `dID`, `bID`, `Consultdate`) VALUES
(1, 2, 13881, '2021-12-31'),
(1, 2, 24064, '2021-12-31'),
(3, 2, 3220, '2021-12-31');
...
INSERT INTO `patients` (`pID`, `pFullName`, `age`, `weight`, `height`, `gender`, `bloodgroup`, `genotype`) VALUES
(1, 'Charles White', 40, 56, 173, 'Male', 'O+', 'AA'),
(2, 'c', 1, 1, 1, 'Male', 'A+', 'AA'),
(3, 'c', 1, 1, 1, 'Male', 'A+', 'AA');
...
INSERT INTO `payment` (`pID`, `bID`, `amount`, `status`, `TreatmentDescription`) VALUES
(1, 13881, 100, 'Paid', 'Consultation'),
(1, 19571, 500, 'Not_Paid', 'Room Stay'),
(1, 24064, 100, 'Not_Paid', 'Consultation'),
(1, 27396, 500, 'Not_Paid', 'Room Stay'),
(3, 3220, 100, 'Not_Paid', 'Consultation');
...
--
ALTER TABLE `assigned_room`
  ADD CONSTRAINT `assigned_room_ibfk_1` FOREIGN KEY (`pID`) REFERENCES `patients` (`pID`) ON DELETE NO ACTION,
  ADD CONSTRAINT `assigned_room_ibfk_2` FOREIGN KEY (`pID`,`bID`) REFERENCES `payment` (`pID`, `bID`) ON DELETE NO ACTION;

--
-- Constraints for table `consultation`
--
ALTER TABLE `consultation`
  ADD CONSTRAINT `consultation_ibfk_1` FOREIGN KEY (`pID`) REFERENCES `patients` (`pID`) ON DELETE NO ACTION,
  ADD CONSTRAINT `consultation_ibfk_2` FOREIGN KEY (`dID`) REFERENCES `doctors` (`dID`) ON DELETE NO ACTION,
  ADD CONSTRAINT `consultation_ibfk_3` FOREIGN KEY (`pID`,`bID`) REFERENCES `payment` (`pID`, `bID`) ON DELETE NO ACTION;
...
--
ALTER TABLE `payment`
  ADD CONSTRAINT `payment_ibfk_1` FOREIGN KEY (`pID`) REFERENCES `patients` (`pID`) ON DELETE NO ACTION;
